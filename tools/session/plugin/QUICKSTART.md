...
claude plugin marketplace add RileyLin/explainify@explainify-session-v0.4.2 \
...
marketplace at the immutable tag so the new plugin version (`0.4.2`) replaces
...
claude plugin details explainify-session@explainify-local   # version 0.4.2
```
